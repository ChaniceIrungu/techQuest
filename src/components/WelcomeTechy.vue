  ...
  <div class="md:flex justify-center h-screen items-center px-2 md:px-6">
    <div class="grid md:grid-cols-2 px-4">
      ...
      <div class="text-center md:text-left place-self-center flex-1">
        <h1
          class="md:pb-10 pb-4 md:text-2xl text-lg text-center md:text-left font-extrabold font-serif text-white break-words flex-1"
        >
          {{ HighlightMsg }}
        </h1>
        <h3
          v-if="!message2"
          class="md:pb-10 pb-4 md:text-xl text-sm text-center md:text-left font-extrabold font-serif text-white text-wrap break-words flex-1"
        >
          {{ message }}
        </h3>
        <div
          v-if="message2"
          class="md:pb-10 pb-4 md:text-xl text-sm font-extrabold font-serif text-white text-wrap break-words"
        >
